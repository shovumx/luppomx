...
export default () => {
  const data = useStaticQuery(graphql`
    query {
      imageThree: file(
        relativePath: { eq: "images/control_accesos_fraccionamiento.jpg" }
      ) {
        childImageSharp {
          fluid(maxWidth: 1200) {
            aspectRatio
      ...
      imageFive: file(relativePath: { eq: "images/app_control_accesos.jpg" }) {
        childImageSharp {
          fluid(maxWidth: 1200) {
            aspectRatio
            sizes
            ...
            <div className="column shake">
              <article className="notification one">
                ...
                <p className="is-size-5">
                  ...
                  aunque venga caminando o en Uber o registrar correctamente la
                  visita.{" "}
                </p>
              </article>
            </div>
          ...
          <div className="columns">
            ...
            <div className="column is-half">
              <Img
                ...
                alt="App para control de accesos de condominios"
              />
            </div>
            <div className="column"></div>
          </div>
        ...
        <div>
          <div className="columns">
            ...
            <div className="column shake">
              ...
              <Video
                  videoSrcURL="https://www.youtube.com/embed/R7FOMi2-ZLY"
                  videoTitle="APP para el control de visitas en condominios"
                />
            </div>
            <div className="column shake">
            ...
            <div className="column is-two-thirds">
              <h2 className="title is-3 has-text-grey-dark has-text-centered">
                ...
                <span className="magical">
                  falta de protocolos confiables en el control de accesos de
                  visitantes?
                </span>
              </h2>
              ...
              <p className="title is-5 has-text-grey">
                Hay muchos condominios y fraccionamientos que confían la
                seguridad en la memoria del vigilante o un tarjetón. Después de
                un tiempo, es más o menos normal que conozca a todos los
                residentes.
              </p>
              <p className="title is-5 has-text-grey">
                El acceso de visitas se hace mediante alguna credencial y la
                casa a la que dice que va. Los problemas surgen cuando una
                persona con malas intenciones busca burlar la seguridad. Con un
                sistema de control de accesos tan rudimentario, su misión de
                vulnerar tu condominio no le va a resultar difícil.
              </p>
              <p className="title is-5 has-text-grey">
                Nuestro control de visitantes busca evitar a toda costa el error
                humano a la hora de registrar a las visitas, proveedores y
                personal de servicio. ¿Qué pasará el día que se enferma tu
                guardia que conoce a todos o simplemente consigue otro trabajo?
                Entonces tu fraccionamiento está en auténtico peligro.
              </p>
              <p className="title is-5 has-text-grey">
                Con <span className="magical">Luppo</span> no es necesario
                utilizar la memoria. El visitante llega, pide acceso y el
                guardia manda una notificación al residente con tres fotografías
                de su visita. En un proceso que dura menos de 20 segundos, el
                residente, desde la comodidad de su hogar, puede revisar las
                tres imágenes y autorizar o rechazar la visita.
              </p>
              <p className="title is-5 has-text-grey">
                A partir de ahí, el guardia solo tiene que esperar a que el
                residente del condominio le dé acceso a su visita. Gracias a
                esto, queda un registro digital de todas las visitas y no es
                necesario que el guardia apunte nada en su bitácora de registro.
                Si pasa alguna situación de riesgo, entonces rápidamente se
                pueden consultar registros por fecha, día, casa o tipo de
                visita.
              </p>
              <Link
                to="/caracteristicas"
          ...
          <div className="columns">
            ...
            <div className="column is-half">
              <Img
                ...
                alt="APP para el control de accesos para condominios y fraccionamientos"
              />
            </div>
            <div className="column"></div>
          </div>
